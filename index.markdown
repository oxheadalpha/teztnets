...
```
docker run -it --entrypoint=/bin/sh tezos/tezos:master_05663567_20210615160752
...
| Tezos docker build | [tezos/tezos:master_05663567_20210615160752](https://hub.docker.com/r/tezos/tezos/tags?page=1&ordering=last_updated&name=master_05663567_20210615160752) |
| Full network name | `TEZOS-DAILYNET-2021-06-16T00:00:00.000Z` |
