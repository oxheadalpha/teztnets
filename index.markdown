...
```
docker run -it --entrypoint=/bin/sh tezos/tezos:master_04f09d7b_20210616125829
...
| Tezos docker build | [tezos/tezos:master_04f09d7b_20210616125829](https://hub.docker.com/r/tezos/tezos/tags?page=1&ordering=last_updated&name=master_04f09d7b_20210616125829) |
| Full network name | `TEZOS-DAILYNET-2021-06-18T00:00:00.000Z` |
