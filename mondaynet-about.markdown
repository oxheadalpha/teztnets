...
| | |
|-------|---------------------|
| Full network name | `TEZOS-MONDAYNET-2022-05-30T00:00:00.000Z` |
...
| Public RPC endpoint | [https://rpc.mondaynet-2022-05-30.teztnets.xyz](https://rpc.mondaynet-2022-05-30.teztnets.xyz) |
| Faucet | [Mondaynet faucet](https://teztnets.xyz/mondaynet-2022-05-30-faucet) |
| Activated on | 2022-05-30T00:00:00.000Z |
...
```
tezos-node config init --network https://teztnets.xyz/mondaynet-2022-05-30
...
>
> ```bash=13
> nohup tezos-node run --rpc-addr 127.0.0.1:8732 > ./node-mondaynet-2022-05-30.log &
> ```
