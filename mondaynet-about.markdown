...
| | |
|-------|---------------------|
| Public RPC endpoint | [https://rpc.mondaynet-2023-01-16.teztnets.xyz](https://rpc.mondaynet-2023-01-16.teztnets.xyz) |
| Faucet | [Mondaynet faucet](https://faucet.mondaynet-2023-01-16.teztnets.xyz) |
| Full network name | `TEZOS-MONDAYNET-2023-01-16T00:00:00.000Z` |
...
```
octez-node config init --network https://teztnets.xyz/mondaynet-2023-01-16
...
>
> ```bash=13
> nohup octez-node run --rpc-addr 127.0.0.1:8732 > ./node-mondaynet-2023-01-16.log &
> ```
