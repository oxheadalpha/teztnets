...
Download the activation file, store it locally (for example in `/tmp/mondaynet-2021-11-01.json`) then run:

```
tezos-client activate account faucet with /tmp/mondaynet-2021-11-01.json
```

<p class="faucet_response" style="display:none;">Or directly use the snippet below:</p>

<div class="faucet_response language-plaintext highlighter-rouge" style="display:none;"><div class="highlight"><pre class="highlight"><code>cat &lt;&lt; EOF &gt; /tmp/mondaynet-2021-11-01.json
...
$("#download_button").click(function() {
    ...
    this.setAttribute('download', 'mondaynet-2021-11-01.json');
})
</script>
