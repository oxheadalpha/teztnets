...
layout: page
title: Mondaynet
permalink: /mondaynet-2021-12-27-about
---
...
| | |
|-------|---------------------|
| Full network name | `TEZOS-MONDAYNET-2021-12-27T00:00:00.000Z` |
...
| Public RPC endpoint | [https://rpc.mondaynet-2021-12-27.teztnets.xyz](https://rpc.mondaynet-2021-12-27.teztnets.xyz) |
| Faucet | [Mondaynet faucet](https://teztnets.xyz/mondaynet-2021-12-27-faucet) |
| Activated on | 2021-12-27T00:00:00.000Z |
...
```
tezos-node config init --network https://teztnets.xyz/mondaynet-2021-12-27
...
>
> ```bash=13
> nohup tezos-node run --rpc-addr 127.0.0.1:8732 > ./node-mondaynet-2021-12-27.log &
> ```
